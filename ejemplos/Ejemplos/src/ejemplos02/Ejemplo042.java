...
public class Ejemplo042 {
    ...
    public static void main(String[] args) {
        ...
        // El proposito de este ciclo es el de dar valores al arreglo4
        // Creando una nueva funcion llamada obtenerSuma 
        for (int i = 0; i < arreglo1.length; i++) {
            for (int j = 0; j < arreglo1[i].length; j++) {
        ...
        // Se utiliza la funcion obtenerReporte para presentar el arreglo4
        obtenerReporte(arreglo4);
    }

    // El objetivo de la funcion es la de sumar los valores de los arreglos y 
